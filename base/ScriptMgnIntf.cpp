...
#if defined(ANDROID)
	buffer = ttstr(TJS_W("global.KirikiriPolyfillRoot = \"system_polyfill/\"; Scripts.execStorage(\"system_polyfill/PolyfillInitialize.tjs\"); // code injection\n")) + buffer;
#else
	buffer = ttstr(TJS_W("global.KirikiriPolyfillRoot = System.exePath + \"system_polyfill/\"; Scripts.execStorage(System.exePath + \"system_polyfill/PolyfillInitialize.tjs\"); // code injection\n")) + buffer;
#endif
}
#endif
